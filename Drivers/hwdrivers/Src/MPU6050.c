...
sensor_status_e MPU6050_set_acc_range(SensorData_t *pSensor, afs_sel_e accRange){
	sensor_status_e retVal;
	uint8_t configReg = sensor_read_register16(MPU6050_I2C_ADRESS_AD0, MPU_REG_ACCEL_CONFIG);
...
sensor_status_e MPU6050_set_gyro_range(SensorData_t *pSensor, fs_sel_e gyroRange){
	sensor_status_e retVal;
	uint8_t configReg = sensor_read_register16(MPU6050_I2C_ADRESS_AD0, MPU_REG_GYRO_CONFIG);
...
uint8_t MPU6050_ReadID(){
	int8_t id = 0;
	id = sensor_read_register16(MPU6050_I2C_ADRESS_AD0, MPU_REG_WHO_AM_I);
	return id;
}
